        ...
        <div class="col-lg-12">
            ...
            <?php foreach ($buku as $b) { ?>
                <form action="<?= base_url('buku/ubahBuku'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control- user" id="pengarang" name="pengarang" placeholder="Masukan nama pangarang" value="<?= $b['pengarang']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form group">
                        ...
                        if (isset($b['image'])) { ?>
                            ...
                            <picture>
                                ...
                                <img src="<?= base_url('assets/img/upload/')['image']; ?>" class="rounded mx-auto mb-3 d-blok" alt="...">
                            </picture>
                    ...
                    <div class="form group">
                        ...
                        <input type="submit" class="form-control form-control-user btn btn-primary col-lg-3" value="Update">
                    </div>
                </form>
            <?php } ?>
        </div>
